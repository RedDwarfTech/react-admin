...
import { addNewRole, rolePage, saveRoleMenuPermission } from '@/services/ant-design-pro/permission/role/role';
...
const RoleModel: IRoleModel = {
    ...
    effects: {
        ...
        *addNewRole({payload: params}, effects) {
            if(!params) return;            
            yield effects.call(addNewRole,  params)
        },
